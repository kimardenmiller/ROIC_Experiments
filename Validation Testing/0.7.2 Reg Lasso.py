...
def create_baseline():
    # create model
    model = Sequential()
    model.add(Dense(num_of_features, input_dim=num_of_features, W_regularizer=l1(0.01), activity_regularizer=activity_l1(0.01)))
    model.add(Dense(num_of_features * 10, init='normal', activation='relu', W_regularizer=l1(0.01), activity_regularizer=activity_l1(0.01)))
    model.add(Dense(num_of_features, init='normal', activation='relu', W_regularizer=l1(0.01), activity_regularizer=activity_l1(0.01)))
...
# Standardized (conventional): 7.54% (22.61%)
